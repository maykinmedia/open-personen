...
class Persoon(models.Model):
    a_nummer_persoon = models.CharField(_("A-nummer persoon"), max_length=10, blank=True)
    burgerservicenummer_persoon = models.CharField(_("Burgerservicenummer persoon"), max_length=9, blank=True)
    ...
    geboortedatum_persoon = models.CharField(_("Geboortedatum persoon"), max_length=8, blank=True,
                                                help_text='Format YYYYMMDD')
    geboorteplaats_persoon = models.CharField(_("Geboorteplaats persoon"), max_length=200, blank=True)
    geboorteland_persoon = models.CharField(_("Geboorteland persoon"), max_length=4, blank=True,
    ...
    vorig_a_nummer = models.CharField(_("Vorig A-nummer"), max_length=10, blank=True)
    volgend_a_nummer = models.CharField(_("Volgend A-nummer"), max_length=10, blank=True)
    ...
    datum_ingang_onderzoek = models.CharField(_("Datum ingang onderzoek"), max_length=8, blank=True,
                                                 help_text='Format YYYYMMDD')
    datum_einde_onderzoek = models.CharField(_("Datum einde onderzoek"), max_length=8, blank=True,
                                                help_text='Format YYYYMMDD')
...
class Ouder(models.Model):
    ...
    a_nummer_ouder = models.CharField(_("A-nummer ouder"), max_length=10, blank=True)
    burgerservicenummer_ouder = models.CharField(_("Burgerservicenummer ouder"), max_length=9, blank=True)
    ...
    geboortedatum_ouder = models.CharField(_("Geboortedatum ouder"), max_length=8, blank=True,
                                              help_text='Format YYYYMMDD')
    geboorteplaats_ouder = models.CharField(_("Geboorteplaats ouder"), max_length=200, blank=True)
    geboorteland_ouder = models.CharField(_("Geboorteland ouder"), max_length=4, blank=True,
                                             help_text='Four digit code')
    ...
    aanduiding_gegevens_in_onderzoek = models.CharField(_("Aanduiding gegevens in onderzoek"), max_length=200,
                                                        blank=True)
    datum_ingang_onderzoek = models.CharField(_("Datum ingang onderzoek"), max_length=8, help_text='Format YYYYMMDD',
                                                 blank=True)
    datum_einde_onderzoek = models.CharField(_("Datum einde onderzoek"), max_length=8, help_text='Format YYYYMMDD',
                                                blank=True)
    indicatie_onjuist_dan_wel_strijdigheid_met_de_openbare_orde = models.CharField(
...
class Nationaliteit(models.Model):
    nationaliteit = models.CharField(_("Nationaliteit"), max_length=4, blank=True, help_text='Four digit code')
