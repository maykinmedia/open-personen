...
class Persoon(models.Model):
    a_nummer_persoon = models.CharField(_("A-nummer persoon"), max_length=200, blank=True)
    burgerservicenummer_persoon = models.CharField(_("Burgerservicenummer persoon"), max_length=200, blank=True)
    ...
    geboortedatum_persoon = models.CharField(_("Geboortedatum persoon"), max_length=200, blank=True,
                                                help_text='Format YYYYMMDD')
    geboorteplaats_persoon = models.CharField(_("Geboorteplaats persoon"), max_length=200, blank=True)
    geboorteland_persoon = models.CharField(_("Geboorteland persoon"), max_length=200, blank=True,
    ...
    volgend_a_nummer = models.CharField(_("Volgend A-nummer"), max_length=200, blank=True)
    ...
    registergemeente_akte_waaraan_gegevens = models.CharField(
        _("Registergemeente akte waaraan gegevens over persoon ontleend zijn"), max_length=200, blank=True,
        help_text='Four digit code')
    ...
    gemeente_waar_de_gegevens_over_persoon = models.CharField(
        _("Gemeente waar de gegevens over persoon aan het document ontleend zijn"), max_length=200, blank=True,
        help_text='Four digit code')
    datum_van_de_ontlening_van_de_gegevens_over_persoon = models.CharField(
        _("Datum van de ontlening van de gegevens over persoon"), max_length=200, blank=True, help_text='Format YYYYMMDD')
    ...
    aanduiding_gegevens_in_onderzoek = models.CharField(_("Aanduiding gegevens in onderzoek"), max_length=6,
    ...
    ingangsdatum_geldigheid_met_betrekking = models.CharField(
        _("Ingangsdatum geldigheid met betrekking tot de elementen van de categorie Persoon"), max_length=200,
        blank=True, help_text='Format YYYYMMDD')
    datum_van_opneming_met_betrekking = models.CharField(
        _("Datum van opneming met betrekking tot de elementen van de categorie Persoon"), max_length=200, blank=True,
        help_text='Format YYYYMMDD')
...
class Ouder(models.Model):
    ...
    burgerservicenummer_ouder = models.CharField(_("Burgerservicenummer ouder"), max_length=200, blank=True)
    ...
    geboortedatum_ouder = models.CharField(_("Geboortedatum ouder"), max_length=200, blank=True,
                                              help_text='Format YYYYMMDD')
    geboorteplaats_ouder = models.CharField(_("Geboorteplaats ouder"), max_length=200, blank=True)
    geboorteland_ouder = models.CharField(_("Geboorteland ouder"), max_length=200, blank=True,
                                             help_text='Four digit code')
    ...
    datum_ingang_familierechtelijke_betrekking_ouder = models.CharField(
        _("Datum ingang familierechtelijke betrekking ouder"), max_length=200, blank=True, help_text='Four digit code')
    registergemeente_akte_waaraan_gegevens_over_ouder_ontleend_zijn = models.CharField(
        _("Registergemeente akte waaraan gegevens over ouder ontleend zijn"), max_length=200, blank=True,
        help_text='Four digit code')
    ...
    gemeente_waar_de_gegevens_over_ouder = models.CharField(
        _("Gemeente waar de gegevens over ouder aan het document ontleend zijn"), max_length=200, blank=True,
        help_text='Four digit code')
    ...
    aanduiding_gegevens_in_onderzoek = models.CharField(_("Aanduiding gegevens in onderzoek"), max_length=200,
                                                        blank=True)
    datum_ingang_onderzoek = models.CharField(_("Datum ingang onderzoek"), max_length=200, help_text='Format YYYYMMDD',
                                                 blank=True)
    datum_einde_onderzoek = models.CharField(_("Datum einde onderzoek"), max_length=200, help_text='Format YYYYMMDD',
                                                blank=True)
    indicatie_onjuist_dan_wel_strijdigheid_met_de_openbare_orde = models.CharField(
        _("Indicatie onjuist dan wel strijdigheid met de openbare orde"), max_length=1, blank=True,
        help_text='One digit code')
    ingangsdatum_geldigheid_met_betrekking = models.CharField(
        _("Ingangsdatum geldigheid met betrekking tot de elementen van de categorie Ouder"), max_length=200,
        help_text='Format YYYYMMDD',
        blank=True)
    datum_van_opneming_met_betrekking = models.CharField(
        _("Datum van opneming met betrekking tot de elementen van de categorie Ouder"), max_length=200,
        help_text='Format YYYYMMDD', blank=True)


class Nationaliteit(models.Model):
    persoon = models.ForeignKey(Persoon, null=True, on_delete=models.CASCADE)
    nationaliteit = models.CharField(_("Nationaliteit"), max_length=200, blank=True, help_text='Four digit code')
    reden_opname_nationaliteit = models.CharField(_("Reden opname nationaliteit"), max_length=3, blank=True,
                                                     help_text='Three digit code')
    reden_beeindigen_nationaliteit = models.CharField(_("Reden beëindigen nationaliteit"), max_length=3, blank=True,
                                                         help_text='Three digit code')
    ...
    gemeente_waar_de_gegevens_over_nationaliteit = models.CharField(
        ...
        max_length=200, blank=True, help_text='Four digit code')
    datum_van_de_ontlening = models.CharField(
        _("Datum van de ontlening dan wel afleiding van de gegevens over nationaliteit"), max_length=200, blank=True,
        help_text='Format YYYYMMDD')
    beschrijving_van_het_document = models.CharField(
    ...
    datum_van_ingang_geldigheid_met_betrekking = models.CharField(
        _("Datum van ingang geldigheid met betrekking tot de elementen van de categorie Nationaliteit"), max_length=200,
        blank=True, help_text='Format YYYYMMDD')
    datum_van_opneming_met_betrekking = models.CharField(
        _("Datum van opneming met betrekking tot de elementen van de categorie Nationaliteit"), max_length=200,
        blank=True, help_text='Format YYYYMMDD')
    rni_deelnemer = models.CharField(_("RNI-deelnemer"), max_length=200, blank=True)
