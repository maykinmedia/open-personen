...
class VerblijfPlaatsHistorie(VerblijfPlaats):
    ...
    def get_instance_dict(response):
        ...
        ['ns:inp.verblijftIn']['ns:historieFormeelRelatie']['ns:gerelateerde']['ns:adresAanduidingGrp']
        ...
        verblijf_plaats_dict = {
            ...
            "inOnderzoek": {
                ...
                "huisnummertoevoeging": bool(antwoord_dict_object['ns:aoa.huisnummertoevoeging']),
                ...
                "naamOpenbareRuimte": bool(antwoord_dict_object['ns:gor.openbareRuimteNaam']),
    ...
    @classmethod
    def list(cls, bsn):
        response = client.get_verblijf_plaats_historie(bsn)
