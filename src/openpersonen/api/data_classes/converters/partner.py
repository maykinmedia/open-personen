        ...
        "geboorte": {
            "datum": {
                "dag": int(
                    ...
                    if is_expected_date_format(partner.geboortedatum_echtgenoot_geregistreerd_partner)
                    else 0
                ),
        ...
        "inOnderzoek": {
            ...
            "datumIngangOnderzoek": {
                "dag": int(
                    ...
                    if is_expected_date_format(partner.datum_ingang_onderzoek)
                    else 0
                ),
        ...
        "aangaanHuwelijkPartnerschap": {
            "datum": {
                "dag": int(
                    ...
                    if is_expected_date_format(partner.datum_huwelijkssluiting_aangaan_geregistreerd_partnerschap)
                    else 0
                ),
