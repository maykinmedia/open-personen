# Generated by Django 2.2.15 on 2020-09-07 15:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nationaliteit', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Nationaliteit')),
                ('reden_opname_nationaliteit', models.IntegerField(blank=True, help_text='Three digit code', max_length=3, verbose_name='Reden opname nationaliteit')),
                ('reden_beeindigen_nationaliteit', models.IntegerField(blank=True, help_text='Three digit code', max_length=3, verbose_name='Reden beëindigen nationaliteit')),
                ...
                ('gemeente_waar_de_gegevens_over_nationaliteit', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Gemeente waar de gegevens over nationaliteit aan het document ontleend dan wel afgeleid zijn')),
                ('datum_van_de_ontlening', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van de ontlening dan wel afleiding van de gegevens over nationaliteit')),
                ...
                ('aanduiding_gegevens_in_onderzoek', models.CharField(blank=True, max_length=200, verbose_name='Aanduiding gegevens in onderzoek')),
                ('datum_ingang_onderzoek', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum ingang onderzoek')),
                ('datum_einde_onderzoek', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum einde onderzoek')),
                ('indicatie_onjuist', models.CharField(blank=True, max_length=200, verbose_name='Indicatie onjuist')),
                ('datum_van_ingang_geldigheid_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van ingang geldigheid met betrekking tot de elementen van de categorie Nationaliteit')),
                ('datum_van_opneming_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van opneming met betrekking tot de elementen van de categorie Nationaliteit')),
                ('rni_deelnemer', models.CharField(blank=True, max_length=200, verbose_name='RNI-deelnemer')),
                ('omschrijving_verdrag', models.CharField(blank=True, max_length=200, verbose_name='Omschrijving verdrag')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('omschrijving_verdrag', models.CharField(blank=True, max_length=200, verbose_name='Omschrijving verdrag')),
                ('a_nummer_ouder', models.IntegerField(blank=True, max_length=10, verbose_name='A-nummer ouder')),
                ('burgerservicenummer_ouder', models.IntegerField(blank=True, max_length=9, verbose_name='Burgerservicenummer ouder')),
                ...
                ('geboortedatum_ouder', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Geboortedatum ouder')),
                ('geboorteplaats_ouder', models.CharField(blank=True, max_length=200, verbose_name='Geboorteplaats ouder')),
                ('geboorteland_ouder', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Geboorteland ouder')),
                ...
                ('datum_ingang_familierechtelijke_betrekking_ouder', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Datum ingang familierechtelijke betrekking ouder')),
                ('registergemeente_akte_waaraan_gegevens_over_ouder_ontleend_zijn', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Registergemeente akte waaraan gegevens over ouder ontleend zijn')),
                ...
                ('gemeente_waar_de_gegevens_over_ouder', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Gemeente waar de gegevens over ouder aan het document ontleend zijn')),
                ('datum_van_de_ontlening_van_de_gegevens_over_ouder', models.IntegerField(blank=True, max_length=200, verbose_name='Datum van de ontlening van de gegevens over ouder')),
                ...
                ('ingangsdatum_geldigheid_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Ingangsdatum geldigheid met betrekking tot de elementen van de categorie Ouder')),
                ('datum_van_opneming_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van opneming met betrekking tot de elementen van de categorie Ouder')),
            ],
        ),
        migrations.CreateModel(
            name='Overlijden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('a_nummer_persoon', models.IntegerField(blank=True, max_length=10, verbose_name='A-nummer persoon')),
                ('burgerservicenummer_persoon', models.IntegerField(blank=True, max_length=9, verbose_name='Burgerservicenummer persoon')),
                ...
                ('geboortedatum_persoon', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Geboortedatum persoon')),
                ('geboorteplaats_persoon', models.CharField(blank=True, max_length=200, verbose_name='Geboorteplaats persoon')),
                ('geboorteland_persoon', models.IntegerField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Geboorteland persoon')),
                ...
                ('vorig_a_nummer', models.IntegerField(blank=True, max_length=10, verbose_name='Vorig A-nummer')),
                ('volgend_a_nummer', models.IntegerField(blank=True, max_length=10, verbose_name='Volgend A-nummer')),
                ('aanduiding_naamgebruik', models.CharField(blank=True, max_length=1, verbose_name='Aanduiding naamgebruik')),
                ('registergemeente_akte_waaraan_gegevens', models.CharField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Registergemeente akte waaraan gegevens over persoon ontleend zijn')),
                ...
                ('gemeente_waar_de_gegevens_over_persoon', models.CharField(blank=True, help_text='Four digit code', max_length=4, verbose_name='Gemeente waar de gegevens over persoon aan het document ontleend zijn')),
                ('datum_van_de_ontlening_van_de_gegevens_over_persoon', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van de ontlening van de gegevens over persoon')),
                ...
                ('aanduiding_gegevens_in_onderzoek', models.IntegerField(blank=True, help_text='Six digit code', max_length=6, verbose_name='Aanduiding gegevens in onderzoek')),
                ('datum_ingang_onderzoek', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum ingang onderzoek')),
                ('datum_einde_onderzoek', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum einde onderzoek')),
                ('indicatie_onjuist_dan_wel_strijdigheid_met_de_openbare_orde', models.CharField(blank=True, max_length=200, verbose_name='Indicatie onjuist dan wel strijdigheid met de openbare orde')),
                ('ingangsdatum_geldigheid_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Ingangsdatum geldigheid met betrekking tot de elementen van de categorie Persoon')),
                ('datum_van_opneming_met_betrekking', models.IntegerField(blank=True, help_text='Format YYYYMMDD', max_length=8, verbose_name='Datum van opneming met betrekking tot de elementen van de categorie Persoon')),
                ('rni_deelnemer', models.CharField(blank=True, max_length=200, verbose_name='RNI-deelnemer')),
            ],
        ),
        migrations.CreateModel(
