...
class TestKindWithTestingModels(APITestCase):
    ...
    def setUp(self):
        ...
        self.partnerschap = Kind.objects.create(persoon=self.persoon,
                                                 burgerservicenummer_kind=1)
    ...
    def test_list_kind(self):
        ...
        self.assertEqual(response.json()['_embedded']['kinderen'][0]['burgerservicenummer'], '1')
