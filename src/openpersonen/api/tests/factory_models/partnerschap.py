...
class PartnerschapFactory(factory.django.DjangoModelFactory):
    ...
    a_nummer_echtgenoot_geregistreerd_partner = factory.Sequence(lambda n: next(a_nummer_generator))
    burgerservicenummer_echtgenoot_geregistreerd_partner = factory.Sequence(lambda n: next(bsn_generator))
