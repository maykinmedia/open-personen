...
os.environ.setdefault("DB_USER", os.getenv("DATABASE_USER", "openpersonen"))
os.environ.setdefault("DB_NAME", os.getenv("DATABASE_NAME", "openpersonen"))
os.environ.setdefault("DB_PASSWORD", os.getenv("DATABASE_PASSWORD", "openpersonen"))
